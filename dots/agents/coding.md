...
- For Spark browser or desktop tasks, load `spark-computer`: agent-browser CLI for pages, Cua MCP for native windows. Use unique pinned browser sessions, serialize native input, preserve Hari's windows, and yield when he takes over.
