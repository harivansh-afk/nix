# Pure prompt setup and theme-aware re-rendering. Sourced by dots/zsh/zshrc.
# The pure-prompt fpath entry is added by the nix-store ~/.zshrc shim before
# this file runs.
